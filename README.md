...
### Offline AI vertigo triage for primary care: Gemma + ICVD reasoning
...
To keep the clinical quality high _and_ the system responsive, the LLM client picks a Gemma variant per request:
...
- **HINTS+ algorithm**: Kattah et al., _Stroke_ 2009 (100% sensitivity for posterior fossa stroke)
- **STANDING protocol**: Vanni et al., _Acad Emerg Med_ 2014 (95% sensitivity, 87% specificity for central cause)
- **TiTrATE framework**: Newman-Toker & Edlow, _Neurol Clin_ 2015
- **GRACE-3 guidelines**: Edlow et al., _Acad Emerg Med_ 2023
- **Ataxia grade-3 specificity**: Carmona & Kaski, _Eur J Neurol_ 2023
...
gantt
    ...
    Pilot deployment at 5 rural primary care centers  :2027-01, 2027-04
...
1. Tarnutzer AA, et al. (2017). ED misdiagnosis of cerebrovascular events in vertigo presentations. _Neurology_. Meta-analysis of 15,721 patients.
2. Rafati A, et al. (2024). Vestibular patient journey: insights from the VeDA registry. _Ann Clin Transl Neurol_.
3. Ruthberg JS, et al. (2021). The economic burden of vertigo and dizziness in the United States. _J Vestib Res_.
...
7. Kattah JC, et al. (2009). HINTS to diagnose stroke in the acute vestibular syndrome. _Stroke_.
8. Garg R, et al. (2025). Grounding LLMs in clinical evidence: a RAG system for NICE guidelines. _arXiv_:2510.02967.
